<template>
  <div class="center">
    ...
    <el-select class="full-width mt-5" v-model="fpdmContent" :placeholder="$t('form.content.textSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="fphmContent" :placeholder="$t('form.content.textSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="xymContent" :placeholder="$t('form.content.textSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="kprqContent" :placeholder="$t('form.content.dateSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="bhsjeContent" :placeholder="$t('form.content.moneySelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="yzContent" :placeholder="$t('form.content.pleaseSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="zfContent" :placeholder="$t('form.content.pleaseSelect')" size="large" :no-data-text="$t('form.content.noField')">
    ...
    <el-select class="full-width mt-5" v-model="chContent" :placeholder="$t('form.content.pleaseSelect')" size="large" :no-data-text="$t('form.content.noField')">
      <el-option v-for="item in fieldList" :key="item.id" :value="item.name" @click="renewField('ch', item)" />
    </el-select>

    <el-button type="primary" class="full-width mt-23" :disabled="able" @click="submitData">{{ $t('form.content.submit') }}</el-button>
  </div>
</template>
